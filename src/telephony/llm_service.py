...
class LLMService:
    ...
    def __init__(self):
        ...
        self.system_prompt = (
            ...
            "1. Listen to the user's FIRST response carefully. "
            "2. If the user speaks English, you MUST speak ONLY English. "
            "3. If the user speaks Hindi, you MUST speak ONLY Hindi. "
            "4. Match the user's language exactly for the entire conversation. "
            "5. Do NOT mix languages (e.g., no 'Namaskara' if speaking English). "
            "6. Default to English if the input is unclear. "
            "If they ask about EMI, say our finance team will help during the visit. "
            "Do not speak anything in brackets."
        )
